...
exports.checkForLoad = undefined;
...
var grid = null;
var $grid = (0, _jquery2.default)('.grid');

var checkForLoad = exports.checkForLoad = function checkForLoad() {
  if (!grid) {
    return;
  }

  (0, _imagesloaded2.default)($grid).progress(function () {
    grid.layout();
  });
...
if ($grid[0]) {
  grid = new _masonryLayout2.default($grid[0], {
