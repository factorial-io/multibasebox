...
var s = (0, _snapsvg2.default)('#logo');
var path1 = s.select('.st0');
var path2 = s.select('.st1');
var path3 = s.select('.st2');
var path4 = s.select('.st3');
var path5 = s.select('.st4');
var path6 = s.select('.st5');
var path7 = s.select('.st6');

var back = false;
var time = 20000;
var ease = mina.easeinout;

var path1d = path1.attr('d');
var path2d = path2.attr('d');
var path3d = path3.attr('d');
var path4d = path4.attr('d');
var path5d = path5.attr('d');
var path6d = path6.attr('d');
var path7d = path7.attr('d');
...
},{"snapsvg":12}],2:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../vendor/bs/modal":9}],3:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../utils/urls":7,"./modal":2}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./components/newsletter":3,"./pages/home":5,"./utils/lazyload":6}],5:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../components/logo":1,"../utils/lazyload":6,"../vendor/bs/collapse":8}],6:[function(require,module,exports){
(function (global){
'use strict';
...
var lazyload = function lazyload($els) {
    ...
    $lazyEls.each(function (index, el) {
        ...
        (0, _jquery2.default)(el).attr('data-src', null).attr('data-srcset', null).attr('data-sizes', null);
    });
};
